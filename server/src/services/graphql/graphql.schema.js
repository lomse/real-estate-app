...
const rootSchema = [
  ...
  type Query {
    ...
    apartment(_id: String location: String): Apartments
    apartments(active: Boolean owner: String location: String limit: Int skip: Int filter: ApartmentFilterParameter): ApartmentsWithPagination
    
    location(_id: String title:String): Locations
